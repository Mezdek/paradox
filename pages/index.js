...
const decodeJWT = (token) => {
  return token ? jwt.verify(token, secret) : undefined;
};
...
export default function Home() {
  ...
  useEffect(() => {
    const loggedUser = getUser(document.cookie);
    setUser(loggedUser);
  }, []);
  ...
  return (
    <div className={style.container}>
      ...
      <section className={style.upperSection}>
        ...
        <Logging showLogIn={showLogIn} setShowLogIn={setShowLogIn} setUser={setUser} />
        <Publish
          user={user}
          create={create}
          setCreate={setCreate}
